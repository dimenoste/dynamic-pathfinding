...
parts_coords = [
    tuple(map(int, parts_coords_str[x].split(",")))
...
print(
    "all body parts coordinates :", snake.get_coords_parts()
)  ## no number part passed as parameter => get the coordinates of all parts body
